...
18. Based on EMS.Rplot.loess.3.pdf, further plot the chromosome you are interest in. Revise the line name in plot_single_chromosome.R, and assign the chromosome number to chromosome variable, for example `chromosome=1`.Then run the script.This step will show all the gene labels of candidate on the chart, it will facilate us to find the causal gene.
#######################Example#########################
